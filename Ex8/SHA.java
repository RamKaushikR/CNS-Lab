public class SHA {
    ...
    public String convertToBinary(String word) {
    ...
    public String hashString(String word, String binary) {
        ...
        return createMessageLength(binary, onePadded, binaryZeros, endBitLength);
